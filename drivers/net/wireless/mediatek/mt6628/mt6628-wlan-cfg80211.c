...
static struct ieee80211_channel mt6628_5ghz_channels[] = {
	...
	{ .center_freq = 4920, .hw_value = 184, .max_power = 30 },
	{ .center_freq = 4940, .hw_value = 188, .max_power = 30 },
	{ .center_freq = 4960, .hw_value = 192, .max_power = 30 },
	{ .center_freq = 4980, .hw_value = 196, .max_power = 30 },
	{ .center_freq = 5000, .hw_value = 200, .max_power = 30 },
	{ .center_freq = 5020, .hw_value = 204, .max_power = 30 },
	{ .center_freq = 5040, .hw_value = 208, .max_power = 30 },
	{ .center_freq = 5060, .hw_value = 212, .max_power = 30 },
	{ .center_freq = 5080, .hw_value = 216, .max_power = 30 },
};
