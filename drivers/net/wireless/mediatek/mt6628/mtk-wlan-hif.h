...
#define MT6628_AUTH_MODE_SHARED		1
#define MT6628_AUTH_MODE_AUTO_SWITCH	2
#define MT6628_AUTH_MODE_WPA		3
#define MT6628_AUTH_MODE_WPA_PSK	4
#define MT6628_AUTH_MODE_WPA2		6
#define MT6628_AUTH_MODE_WPA2_PSK	7

#define MT6628_ENCRYPTION_WEP_ENABLED	0
#define MT6628_ENCRYPTION_DISABLED	1
#define MT6628_ENCRYPTION2_ENABLED	4
#define MT6628_ENCRYPTION3_KEY_ABSENT	7

#define MT6628_CIPHER_SUITE_WEP40	1
#define MT6628_CIPHER_SUITE_TKIP	2
#define MT6628_CIPHER_SUITE_CCMP	4
#define MT6628_CIPHER_SUITE_WEP104	5
