...
static int pwrap_mt6582_init_reg_clock(struct pmic_wrapper *wrp)
{
	switch (wrp->slave->type) {
	case PMIC_MT6323:
		pwrap_writel(wrp, 0x8, PWRAP_RDDMY);
		pwrap_write(wrp, wrp->slave->dew_regs[PWRAP_DEW_RDDMY_NO],
			    0x8);
		pwrap_init_chip_select_ext(wrp, 7, 0, 0, 0);
	 	break;
	default:
	 	break;
	}
...
static int pwrap_mt6582_init_soc_specific(struct pmic_wrapper *wrp)
{
...
static int pwrap_init(struct pmic_wrapper *wrp)
{
	...
	case PWRAP_MT6582:
		...
		/* MT6323 needs OP_TYPE=0 (CK mode), MSB_FIRST=1 */
...
static const struct pmic_wrapper_type pwrap_mt6582 = {
	...
	.type = PWRAP_MT6582,
	.arb_en_all = 0x1ff,
	.int_en_all = 0x7fffff0,	//0x7fffffff,
	.int1_en_all = 0,
	.spi_w = PWRAP_MAN_CMD_SPI_WRITE,
	.wdt_src = PWRAP_WDT_SRC_MASK_ALL,
	.caps = PWRAP_CAP_RESET | PWRAP_CAP_DCM,
	.init_reg_clock = pwrap_mt6582_init_reg_clock,
	.init_soc_specific = pwrap_mt6582_init_soc_specific,
};
