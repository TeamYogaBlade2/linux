...
{
	PVR_LOG_MTKPP(("\tSyncInfo %d:", psKernelSyncInfo->ui32UID));
	PVR_LOG_MTKPP(("\t\tWrite ops (0x%08x): P/C = %d/%d (0x%08x/0x%08x)",
				psKernelSyncInfo->sWriteOpsCompleteDevVAddr.uiAddr,
				psKernelSyncInfo->psSyncData->ui32WriteOpsPending,
				psKernelSyncInfo->psSyncData->ui32WriteOpsComplete,
				psKernelSyncInfo->psSyncData->ui32WriteOpsPending,
				psKernelSyncInfo->psSyncData->ui32WriteOpsComplete));
	PVR_LOG_MTKPP(("\t\tRead ops (0x%08x): P/C = %d/%d (0x%08x/0x%08x)",
				psKernelSyncInfo->sReadOpsCompleteDevVAddr.uiAddr,
				psKernelSyncInfo->psSyncData->ui32ReadOpsPending,
				psKernelSyncInfo->psSyncData->ui32ReadOpsComplete,
				psKernelSyncInfo->psSyncData->ui32ReadOpsPending,
				psKernelSyncInfo->psSyncData->ui32ReadOpsComplete));
	PVR_LOG_MTKPP(("\t\tRead ops 2 (0x%08x): P/C = %d/%d (0x%08x/0x%08x)",
	...
	{
		IMG_UINT32 i;
		PVR_LOG_MTKPP(("\t\t --- Per sync debug ---"));

		PVR_LOG_MTKPP(("\t\tOperationMask = 0x%08x", psKernelSyncInfo->ui32OperationMask));
		...
		for (i=0;i<PER_SYNC_HISTORY;i++)
		{
			...
			if (ui32OpInfo & SYNC_OP_HAS_DATA)
			{
				...
				PVR_LOG_MTKPP(("\t\tOperation last - %d\n", PER_SYNC_HISTORY - i));
				...
				PVR_LOG_MTKPP(("\t\t\tui32OpType = 0x%08x", ui32OpInfo));
				PVR_LOG_MTKPP(("\t\t\t\t%s, %s, %s, %s",
							pzClass,
							pzType,
							(ui32OpInfo & SYNC_OP_TAKE) ?"TAKE":"No TAKE",
							(ui32OpInfo & SYNC_OP_ROLLBACK) ?"ROLLBACK":"No ROLLBACK"));

				PVR_LOG_MTKPP(("\t\t\ti32ReadOpSample = %d (0x%08x)",
							psKernelSyncInfo->aui32ReadOpSample[ui32Index],
							psKernelSyncInfo->aui32ReadOpSample[ui32Index]));
				PVR_LOG_MTKPP(("\t\t\taui32WriteOpSample = %d (0x%08x)",
							psKernelSyncInfo->aui32WriteOpSample[ui32Index],
							psKernelSyncInfo->aui32WriteOpSample[ui32Index]));
				PVR_LOG_MTKPP(("\t\t\taui32ReadOp2Sample = %d (0x%08x)",
