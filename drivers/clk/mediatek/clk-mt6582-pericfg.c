...
static const struct mtk_gate peri_gates[] = {
	GATE_PERI0(CLK_PERI_SPI0, "spi0_ck", "spi_sel", 25),
	...
	GATE_PERI0(CLK_PERI_UART3, "uart3_ck", "uart_sel", 19),
	GATE_PERI0(CLK_PERI_UART2, "uart2_ck", "uart_sel", 18),
	GATE_PERI0(CLK_PERI_UART1, "uart1_ck", "uart_sel", 17),
	GATE_PERI0(CLK_PERI_UART0, "uart0_ck", "uart_sel", 16),
	...
	GATE_PERI0(CLK_PERI_PWM, "pwm_ck", "pwm_sel", 9),
	GATE_PERI0(CLK_PERI_PWM7, "pwm7_ck", "pwm_sel", 8),
	GATE_PERI0(CLK_PERI_PWM6, "pwm6_ck", "pwm_sel", 7),
	GATE_PERI0(CLK_PERI_PWM5, "pwm5_ck", "pwm_sel", 6),
	GATE_PERI0(CLK_PERI_PWM4, "pwm4_ck", "pwm_sel", 5),
	GATE_PERI0(CLK_PERI_PWM3, "pwm3_ck", "pwm_sel", 4),
	GATE_PERI0(CLK_PERI_PWM2, "pwm2_ck", "pwm_sel", 3),
	GATE_PERI0(CLK_PERI_PWM1, "pwm1_ck", "pwm_sel", 2),
