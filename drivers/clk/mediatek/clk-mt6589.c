...
static const struct mtk_gate infra_clks[] = {
	...
	// GATE_INFRA(CLK_INFRA_AUDIO, "infra_audio", "audintbus_sel", 3),
	// GATE_INFRA(CLK_INFRA_CEC, "infra_cec", "", 4),
	// GATE_INFRA(CLK_INFRA_MFGAXI, "infra_mfgaxi", "", 5),
	// GATE_INFRA(CLK_INFRA_M4U, "infra_m4u", "", 6),
	// GATE_INFRA(CLK_INFRA_MD1MCUAXI, "infra_md1mcuaxi", "", 7),
	// GATE_INFRA(CLK_INFRA_MD1HWMIXAXI, "infra_md1hwmixaxi", "", 8),
	// GATE_INFRA(CLK_INFRA_MD1AHB, "infra_md1ahb", "", 9),
	// GATE_INFRA(CLK_INFRA_MD2MCUAXI, "infra_md2mcuaxi", "", 10),
	// GATE_INFRA(CLK_INFRA_MD2HWMIXAXI, "infra_md2hwmixaxi", "", 11),
	// GATE_INFRA(CLK_INFRA_MD2AHB, "infra_md2ahb", "", 12),
	// GATE_INFRA(CLK_INFRA_CPUM, "infra_cpum", "", 13),
	// GATE_INFRA(CLK_INFRA_KP, "infra_kp", "", 14),
	// GATE_INFRA(CLK_INFRA_CCIF0, "infra_ccif0", "", 15),
	// GATE_INFRA(CLK_INFRA_CCIF1, "infra_ccif1", "", 16),
	// GATE_INFRA(CLK_INFRA_PMICSPI, "infra_pmicspi", "", 17),
	// GATE_INFRA(CLK_INFRA_PMICWRAP, "infra_pmicwrap", "", 18),
};
